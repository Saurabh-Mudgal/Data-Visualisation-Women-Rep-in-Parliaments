...
d3.select(".topicFour").text("In Andorra there was the highest increase in women representation. A rise of " + change + "% reflecting an increase from " + (female-change) + "% in 2015-2018 to an even " + female + "% female MLAs in 2019.") ;
...
class gender3DDemo_country {
    ...
    const modelDiv = document.getElementById('rwanda');
    ...
    this._LoadAnimatedModelAndPlay(
        ...
        'claire_reaction.fbx', new THREE.Vector3(0,0,0), female/totalCandidates, -15, 4, 4, 4, './src/Assets/flagAndorra.jpg', 1);
    this._LoadAnimatedModelAndPlay(
        './src/Assets/3D/', 'phil.fbx',
        'phil_Reaction.fbx', new THREE.Vector3(0,0,0), male/totalCandidates, 15, 4, 4, 4, './src/Assets/flagAndorra.jpg', 1);
    ...
    const checkpoint = 8370;
    const transpoint = 8228;
    const checkpoint2 = 8025;
    const transpoint2 = 7590;
    let alph = 1;
    ...
    document.querySelector("#rwanda").style.opacity = alph;
    }
