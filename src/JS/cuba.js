...
d3.select(".topicSixA").text("Our close neighbours Thailand also saw an impressive " + change + "% change - accounting for an increase from " + (female-change) + "% in 2018 to" + female + "% female MLAs in 2019") ;
...
class gender3DDemo {
    ...
    const modelDiv = document.getElementById('cuba');
    ...
    this._LoadAnimatedModelAndPlay(
        ...
        'claire_reaction.fbx', new THREE.Vector3(0,0,0), female/totalCandidates, -15, 4, 4, 4, './src/Assets/flagPalau.jpg');
    this._LoadAnimatedModelAndPlay(
        './src/Assets/3D/', 'phil.fbx',
        'phil_Reaction.fbx', new THREE.Vector3(0,0,0), male/totalCandidates, 15, 4, 4, 4, './src/Assets/flagPalau.jpg');
    ...
    const checkpoint = 9135;
    const transpoint = 9000;
    const checkpoint2 = 8800;
    const transpoint2 = 8370;
    let alph = 1;
    ...
    document.querySelector("#cuba").style.opacity = alph;
    }
