...
d3.select(".topicSixB").text("Egypt, as well, had a upwards trend. A change of " + change + "% in women representation increased female MLAs from " + (female-change) + "% in 2012 to an even" + female + "% in 2016") ;
...
class gender3DDemo {
    ...
    const modelDiv = document.getElementById('egypt');
    ...
    this._LoadAnimatedModelAndPlay(
        ...
        'claire_reaction.fbx', new THREE.Vector3(0,0,0), female/totalCandidates, -15, 4, 4, 4, './src/Assets/flagEgypt.png');
    this._LoadAnimatedModelAndPlay(
        './src/Assets/3D/', 'phil.fbx',
        'phil_Reaction.fbx', new THREE.Vector3(0,0,0), male/totalCandidates, 15, 4, 4, 4, './src/Assets/flagEgypt.png');
    ...
    const checkpoint = 11640;
    const transpoint = 11490;
    const checkpoint2 = 10330;
    const transpoint2 = 9895;
    let alph = 1;
    ...
    document.querySelector("#egypt").style.opacity = alph;
    }
